...
class UI_Logic_Window(QtWidgets.QMainWindow):
    ...
    def model_init(self):
        ...
        # 设置提示框
        QtWidgets.QMessageBox.information(self, u"Notice", u"Loading Successfully", buttons=QtWidgets.QMessageBox.Ok,
                                      defaultButton=QtWidgets.QMessageBox.Ok)
    ...
    def button_video_open(self):
        ...
        if not flag:
            QtWidgets.QMessageBox.warning(self, u"Warning", u"Opening Video Failed", buttons=QtWidgets.QMessageBox.Ok,defaultButton=QtWidgets.QMessageBox.Ok)
        else:
            #-------------------------写入视频----------------------------------#
    ...
    def button_video_stop(self):
        ...
        if self.timer_video.isActive() == True and self.num_stop%2 == 1:
            self.ui.pushButton_stop.setText(u'Pause') # 当前状态为暂停状态
    ...
    def finish_detect(self):
        ...
        if self.num_stop%2 == 0:
            ...
            self.ui.pushButton_stop.setText(u'Pause/Continue')
            self.num_stop = self.num_stop + 1
            self.timer_video.blockSignals(False)
